...
var todo = document.getElementById('todo'); // import React,{Component} from 'react';
// import ReactDOM from 'react-dom';

var addBtn = document.getElementById('addBtn');
var weight = document.getElementById('weight');
var height = document.getElementById('height');
var weight$ = _rxjs2.default.Observable.fromEvent(weight, 'keyup');
var height$ = _rxjs2.default.Observable.fromEvent(height, 'keyup');
var btnClick$ = _rxjs2.default.Observable.fromEvent(addBtn, 'click').mapTo('click');
btnClick$.subscribe(function (input) {
    console.log(input);
});
var input$ = _rxjs2.default.Observable.fromEvent(todo, 'keyup');
input$.subscribe(function (input) {
    console.log(input.target.value);
});
// 合成最近的值
_rxjs2.default.Observable.combineLatest(weight$, height$, function (w, h) {
